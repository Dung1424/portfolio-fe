<template>
    <div class="details-category">
                ...
                <nav class="breadcrumb">
                    <NuxtLink to="/categories" class="breadcrumb-back"><i class="fas fa-arrow-left"></i> <strong>Back</strong></NuxtLink>
                    <NuxtLink to="/categories" class="breadcrumb-link">Explore Categories</NuxtLink>
...
export default {
    ...
    methods: {
        ...
        async fetchPhotos() {
            ...
            try {
                const response = await homeService.fetchPhotosByCategorySlugs(slugs, {
