    ...
    <div id="portfolio-grid" class="row no-gutter" data-aos="fade-up" data-aos-delay="200">
        <div v-for="item in photos" :key="item.id" class="item web col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="item-wrap fancybox">
                <NuxtLink :to="{ name: 'PhotoDetail', params: { token: item.photo_token } }">
                    <img v-lazy="`${item.image_url}`" class="img-fluid rounded-image" alt="">
                </NuxtLink>
                <div class="work-info">
                    <div class="user-info2">
                        <NuxtLink :to="{ name: 'MyProfile', params: { username: item.user.username } }">
...
<script>
import lazyDirective from '~/services/lazy.js';
...
export default {
    ...
    mounted() {
        // localStorage chỉ có trên trình duyệt — không dùng created() khi SSR
