    ...
    <div class="galleries-grid">
        <div class="photo-card create-gallery-card">
            ...
            <div class="gallery-create">
                <button @click="$emit('create-photo')" class="create-gallery-button">Upload</button>
            </div>
        </div>
