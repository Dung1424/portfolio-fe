    ...
    <div class="galleries-grid">
        <div class="gallery-card create-gallery-card">
            ...
            <div class="gallery-create">
                <button @click="$emit('create-gallery')" class="create-gallery-button">Create a Gallery</button>
            </div>
        </div>
        <div
            class="gallery-card"
        ...
        >
            ...
            <div v-if="activeDropdown === 'dropdown-' + gallery.id" class="dropdown-content show" @click.stop>
                <ul>
                    <li @click="$emit('edit-gallery', gallery.galleries_code)">
                        <i class="fas fa-edit"></i> Edit Gallery
                    </li>
                    <li @click="$emit('delete-gallery', gallery)">
